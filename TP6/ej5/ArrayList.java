...
public class ArrayList<E> implements List<E> {
  ...
  public E remove(int i) throws IndexOutOfBoundsException {
    ...
    size--;
    // Si el espacio libre es mayor o igual a CAPACITY, reducir el tamaño del array
    if (data.length - size >= CAPACITY) { //data.length es el tamaño del array, size es el número de elementos 
      resize(size);  // Redimensionar el array al tamaño actual
    }
    return temp;
  }
