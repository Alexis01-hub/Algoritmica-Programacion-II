 ...
 * lista nueva 
  ...
  */ 
  public void swap(int x, int y){
    ...
    // Aseguramos que x sea menor que y
    int z;
    if(x > y) {
      z = x;
      x = y;
    ...
    while (i < y){
      if (i == x) {
        aux = walk; // guardamos el nodo en la posición x
      }
      i++;
      walk = walk.getNext(); // avanzamos al siguiente nodo
    }

    E temp = aux.getElement();
    aux.element = walk.getElement();
    walk.element = temp;
